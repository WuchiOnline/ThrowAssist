...
Jump straight to the logic here: [Assets/WuchiOnline/Scripts/Wuchi_ThrowAssist.cs](https://github.com/WuchiOnline/ThrowAssist/blob/master/Assets/WuchiOnline/Scripts/Wuchi_ThrowAssist.cs)
